...
function apiGetResponse(query) {
  ...
  if (lowerQuery.includes("quem somos")) {
    return "Somos uma empresa especializada em produzir paínes solares de forma eficiente e econômica aqui em Salvador e na região.";
  } else if (
    lowerQuery.includes("serviços") ||
    lowerQuery.includes("servicos") ||
    lowerQuery.includes("nossos serviços")
  ) {
    return "Oferecemos soluções de assistência técnica, concessionária de energia e auditoria de desempenho e consumo.";
  } else if (
    lowerQuery.includes("contato") ||
    lowerQuery.includes("contatos")
  ) {
    return "Entre em contato via email: eyseg.solar@gmail.com ou https://wa.me/55719287-3704";
  } else {
